...
#include "motor.h"
    ...
    void motor::backward(byte vehicle_speed) {
      analogWrite(forward_pin, 0);                  //De digitale pins kan sende et "analogWrite".
      analogWrite(backward_pin, vehicle_speed);     //https://www.arduino.cc/reference/en/language/functions/analog-io/analogwrite/
    }
